# Contribution Guidelines for the grunt-l10n-lint

Anyone is welcome to help with the grunt-l10n-lint project. Feel free to
get in touch with other community members on IRC, the mailing list or
through issues here on GitHub.
...
See the main [README.md](/README.md) for information on installing, running and testing.
...
### Scope
The scope could be anything specifying place of the commit change. For example `test`, `check`, etc...
